...
const unsigned char vendorIDT10[] = "INFINEON ";

/* Should not exceet 16 characters. */
const unsigned char productID[] = "PMG1 USB MSC";
...
********************************************************************************
* Summary:
*  Function returns fail as this command is not supported.
*
* Parameters:
*  context: pointer to the USB MSC context
*
...
*  context: pointer to the USB MSC context
*
*  mem: pointer to the emulated memory in SRAM
*
* Return:
*  Always success
*
...
{
    // Uncomment the below lines if you wish to support file write from host.
    // Handle button press write when host sends this command
    // /* Copy the USB data to buffer */
    // if(0 < context->packet_out_size)
    // {
    //    memcpy((mem+context->start_location), context->out_buffer, context->packet_out_size);
    // }
